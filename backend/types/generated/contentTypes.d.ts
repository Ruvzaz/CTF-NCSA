...
export interface ApiChallengeChallenge extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    firstBlood: Schema.Attribute.String;
    ...
    solveCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['Jeopardy', 'Attack/Defense', 'Mixed']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiNewsNews extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    content_blocks: Schema.Attribute.DynamicZone<['ui.button']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    image: Schema.Attribute.Media<'images'>;
...
export interface ApiSubmissionSubmission extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    pointsAwarded: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    submittedFlag: Schema.Attribute.String & Schema.Attribute.Private;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiWriteupWriteup extends Struct.CollectionTypeSchema {
  collectionName: 'writeups';
  info: {
    displayName: 'Write-up';
    pluralName: 'writeups';
    singularName: 'writeup';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::writeup.writeup': ApiWriteupWriteup;
